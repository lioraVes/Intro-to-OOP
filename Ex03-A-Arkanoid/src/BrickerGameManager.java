...
public class BrickerGameManager extends GameManager {
     ...
     * privates: PADDLE_WIDTH,PADDLE_HEIGHT,BALL_RADIUS,BALL_SPEED,start position of the bricks,
     * number of bricks in a row, number of bricks in a column.
     */
    ...
    /**
     * private constants fields: dimensions of the window, brick,heart and number of lives.
     */
    ...
    private void createLives(ImageReader imageReader) {
        ...
        Vector2 numLivesTopLeftCorner = new Vector2(60, WINDOW_DIMENSIONS.y() - 25);
    ...
    private void createPaddle(ImageReader imageReader, UserInputListener inputListener) {
        ...
        userPaddle = new Paddle(Vector2.ZERO, new Vector2(PADDLE_WIDTH, PADDLE_HEIGHT), paddleImage,
    ...
    private void createBorders() {
        GameObject leftBorder = new GameObject(Vector2.ZERO, new Vector2(BORDER_WIDTH, WINDOW_DIMENSIONS.y())
                , null);
        gameObjects().addGameObject(leftBorder, Layer.STATIC_OBJECTS);

        GameObject rightBorder = new GameObject(new Vector2(WINDOW_DIMENSIONS.x() - BORDER_WIDTH, 0)
                , new Vector2(BORDER_WIDTH, WINDOW_DIMENSIONS.y()), null);
        gameObjects().addGameObject(rightBorder, Layer.STATIC_OBJECTS);

        GameObject ceilingBorder = new GameObject(Vector2.ZERO, new Vector2(WINDOW_DIMENSIONS.x(),
                BORDER_WIDTH), null);
